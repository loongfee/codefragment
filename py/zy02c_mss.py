...
inFolder = r'I:\20141030'
outFolder = r'I:\result\zy02c\PMS-albers'
prjFile = r'G:\zy02c_mss.txt'
prefFile = r'D:\opensource\ossim\preference.txt'
if not os.path.exists(outFolder):
    os.makedirs(outFolder)

#ZY02C_HRC_E116.3_N39.8_20141018_L1C0001878745-HR1.tiff
fileList = findAllFiles(inFolder, pat = r'ZY02C_PMS.*\.tiff$')
...
for i in range(0,nFiles):
    ...
    outFile = outFolder + '\\o' + name_without_ext + '.tif'
